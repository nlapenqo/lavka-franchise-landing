...
/* ───── 3. Маятник: бирка качается на узелке, затухая, и повисает на черенке ───── */
{
  ...
  variants.push({ n: 3, title: 'Маятник', desc: 'Ось вращения — узелок. Бирка появляется крупно с колечком, качнувшись, летит к авокадо; авокадо проявляется на долю секунды раньше контента, в полёте из точки в колечке вырастает верёвочка, на посадке ставится узелок; контент выходит лесенкой прямо во время полёта.', css });
}
